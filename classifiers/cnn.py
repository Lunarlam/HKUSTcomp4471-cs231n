...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        pad=(filter_size-1)//2
        H_out = (H + 2 * pad - filter_size) // 1 + 1
        W_out = (W + 2 * pad - filter_size) // 1 + 1
    ...
    def loss(self, X, y=None):
        ...
        scores,cache = general_forward(out_aff,W3,b3,last=True)
        ...
        dout,grads['W3'],grads['b3'],_,_=general_backword(dout,cache)    
        dout,grads['W2'],grads['b2'],=affine_relu_backward(dout,cache_aff) 
